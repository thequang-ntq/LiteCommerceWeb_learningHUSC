...
namespace SV22T1020362.BusinessLayers
{
    ...
    /// bao gồm: loại hàng (Category), mặt hàng (Product), 
    /// thuộc tính của mặt hàng (ProductAttribute) và ảnh của mặt hàng (ProductPhoto).
    /// </summary>
    public static class CatalogDataService
    {
        ...
        /// <returns>Kết quả tìm kiếm dưới dạng danh sách loại hàng có phân trang.</returns>
        ...
        /// <returns>Đối tượng Category nếu tìm thấy, ngược lại trả về null.</returns>
        ...
        /// <returns>True nếu loại hàng đang được sử dụng, ngược lại False.</returns>
        ...
        /// </summary>
        /// <param name="input">Thông tin tìm kiếm và phân trang mặt hàng.</param>
        /// <returns>Kết quả tìm kiếm dưới dạng danh sách mặt hàng có phân trang.</returns>
        ...
        /// <returns>Đối tượng Product nếu tìm thấy, ngược lại trả về null.</returns>
        ...
        /// <returns>True nếu mặt hàng đang được sử dụng, ngược lại False.</returns>
        ...
        /// <returns>Đối tượng ProductAttribute nếu tìm thấy, ngược lại trả về null.</returns>
        ...
        /// <returns>Đối tượng ProductPhoto nếu tìm thấy, ngược lại trả về null.</returns>
        ...
        public static async Task<long> AddPhotoAsync(ProductPhoto data)
        {
            ...
            if (string.IsNullOrWhiteSpace(data.Photo))
                throw new ArgumentException("Tên file ảnh không được để trống.");
            if (data.DisplayOrder < 0)
                throw new ArgumentException("Thứ tự hiển thị không được âm.");
